...
contract CakeLPStrategyV1 is Ownable, Pausable {
     ...
     * {balle} - Ballena.io token, used to send performance fee to rewards contract.
    ...
    function chargeFees() internal {
        ...
        IPancakeRouter(unirouter).swapExactTokensForTokens(rewardsFee, 0, wbnbToBalleRoute, rewards, block.timestamp.add(600));
    }
