...
contract StrategyCakeLP is Ownable, Pausable {
     ...
     * {balle} - Ballena.io token, used to send funds to the treasury.
    ...
    function chargeFees() internal {
        ...
        IPancakeRouter(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wbnbToBalleRoute, treasury, block.timestamp.add(600));
