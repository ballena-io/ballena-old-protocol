...
contract PancakeRouter is IPancakeRouter02 {
    ...
    function addLiquidity(
        ...
        //
        liquidity = IPancakePair00(pair).mint(to);
    }
    ...
    function swapExactTokensForTokens(
        ...
        // MODIFIED ON MOCK
        uint amountOut = amountOutMin == 0 ? amountIn : amountOutMin;
        IERC20(path[0]).transferFrom(msg.sender, address(this), amountIn);
        IERC20(path[1]).transferFrom(address(this), to, amountOut);
        //
    }
